...
export default function WishlistItems() {
  ...
  const { mutate: addProductToCart } = useContext(CartContext);
                  ...
                  <div key={wish._id} className="flex flex-col">
                    ...
                    <div className="mt-6 flex justify-between items-center">
                      <div className="flex justify-center items-center">
                        <p className="tracking-tight text-2xl font-semibold leading-6 text-gray-800 dark:text-white">{wish.title || 'Product Title'}</p>
                      </div>
                      <div className="flex justify-center items-center">
                        <button
